  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:image"
          content={new URL(asset("/Birb-engine-og.png"), props.url)
            .href}
        />
      </Head>
